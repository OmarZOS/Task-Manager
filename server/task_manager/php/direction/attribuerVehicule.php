...
//*Need un json qui contient password or something unique for user */
 ...
 if($base)
        ...
        $LABEL_VEHICULE=  $obj-> LABEL_VEHICULE; 
        $n= $obj->label; 
		$d= $obj-> dateDeb;
		$e= $obj-> periode;
        ...
        $sql3="select  ID_VEHICULE from VEHICULE where LABEL_VEHICULE='$LABEL_VEHICULE'";
        $resultat1 = mysqli_query($base,$sql3);
        $id_vehicule = mysqli_fetch_array($resultat1);


        $sql1 = "INSERT INTO necissitedirV  VALUES ($id_tache[0],$id_vehicule[0] ,'$d','$e')" ;
