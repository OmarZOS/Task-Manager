...
class SharedPreferencesHelper {
  ...
  //Method to retrieve User model in json format
  ...
  Future<String> getChildIds() async {
    ...
    // await {AppUser(displayName: 'flenn1',id: 'jgd'),AppUser(displayName: 'flenn2',id: 'jgd2'),AppUser(displayName: 'flenn3',id: 'jgd5')};
  ...
  Future<bool> setUserType(UserType userType) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    bool res =
        await prefs.setString(_userType, UserTypeHelper.getValue(userType).toString());
  ...
  Future<UserType> getUserType() async {
    ...
    log('User Type Returned ' + userType);
