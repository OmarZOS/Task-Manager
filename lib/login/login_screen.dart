...
import 'package:task_manager/pages/GuardianProfile.dart';
import 'package:task_manager/pages/Home.dart';
import 'package:task_manager/pages/ProfilePage.dart';
import '../locator.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  AuthenticationServices _authenticationService = locator<AuthenticationServices>();


  Duration get loginTime => Duration(milliseconds: timeDilation.ceil() * 900);//2250
  ...
  Widget build(BuildContext context) {
    return FlutterLogin(
      ...
      //   recoverPasswordDescription: 'Everything will be fine, no worries..',
